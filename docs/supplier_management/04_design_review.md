...
- Normative design: `03_design_spec.md` 1.0 Aligned.
...
1. Business Master has an approved ownership decision but may not have implementation; this blocks Supplier Core rather than just degrading it.
