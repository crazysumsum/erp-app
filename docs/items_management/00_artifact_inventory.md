...
| `06_technical_test_cases.md` | Canonical planned technical specification plus historical developer evidence | `fd8a4dd` / legacy SHA above | Same file, Appendix A formal TC definitions | Full detailed risk catalogue and NOT_RUN meaning | `KEEP_CANONICAL`; no result promoted | Runner implemented on 2026-09-15; trust policy/environment still pending |
