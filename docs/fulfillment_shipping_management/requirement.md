# Fulfillment & Shipping Management 業務需求書
...
本節只定義可獨立驗收的能力成果；實際工程任務由後續 `tasks.md` 拆分。
...
本文件簽核後，方可產出 `design_spec.md`。技術設計不得把未確認的 WMS、Carrier、Return、Invoicing 或 Accounting 能力放入第一階段。
