...
test("TC-011 accepts the approved high-risk lifecycle route keys", async () => {
  ...
  for (const routeKey of ["customer.code_change", "customer.activate", "customer.suspend", "customer.reactivate", "customer.archive", "customer.restore", "customer.delete", "customer.attachment.upload"]) {
